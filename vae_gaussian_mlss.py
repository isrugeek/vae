...
# For this code i didn't copy both methods as Normal and Bayesian one I choosed the one woth b etter accuracy.
...
def vae(observed, n, n_x, n_z, n_samples, is_training):
    with zs.BayesianNet(observed=observed) as model:
        ...
        x = zs.Normal('x',mean=x_mean, logstd = x_logits, group_ndims=1)
    return model
